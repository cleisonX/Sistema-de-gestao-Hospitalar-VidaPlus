...
Ao entrar na vídeo chamada aparece a tela de vídeo com resumo profissional, sua câmera e com botões interativos, ao encerrar a vídeo chamada a consulta deve sumir, mais não foi implementado. 
...
Na tela do profissional de saúde, tem a sua agenda aonde aparece alguns exemplos. 
Os atendimentos que são telemedicina, ao entrar na chamada, leva para a tela telemedicina , onde tem botões interativos e pode ser anotado a prescrição do paciente e no presencial abre a tela de anotações aonde salva o histórico e vai para a tela para gerar a receita. 
Receitas geradas ficam salvas no prontuário. 
...
O administrador pode adicionar profissional e pacientes, editar os dados e excluir e não foi implementado, só demonstração. 
...
A tela de relatórios, gera 2 tipos de relatórios, financeiro e operacional e mostra os dados, foi implementado alguns exemplos.
